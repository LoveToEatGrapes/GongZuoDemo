 ...
 * 正常排序
 */
public class WordGroupViewFour extends View {
    ...
    private List<WordGroupViewFour.DrawPoint> drawPointList = new ArrayList<>();
    ...
    public WordGroupViewFour(Context context, AttributeSet attrs) {
        super(context, attrs);
