...
public class DashboardView extends View {
    ...
    public DashboardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRadius = a.getDimensionPixelSize(R.styleable.DashboardView_radius1, dpToPx(80));
        mStartAngle = a.getInteger(R.styleable.DashboardView_startAngle1, 180);
        mSweepAngle = a.getInteger(R.styleable.DashboardView_sweepAngle1, 180);
        mBigSliceCount = a.getInteger(R.styleable.DashboardView_bigSliceCount1, 10);
        mSliceCountInOneBigSlice = a.getInteger(R.styleable.DashboardView_sliceCountInOneBigSlice1, 5);
        mArcColor = a.getColor(R.styleable.DashboardView_arcColor1, Color.WHITE);
        mMeasureTextSize = a.getDimensionPixelSize(R.styleable.DashboardView_measureTextSize1, spToPx(12));
        mTextColor = a.getColor(R.styleable.DashboardView_textColor1, mArcColor);
        mHeaderTitle = a.getString(R.styleable.DashboardView_headerTitle1);
        if (mHeaderTitle == null) mHeaderTitle = "";
        mHeaderTextSize = a.getDimensionPixelSize(R.styleable.DashboardView_headerTextSize1, spToPx(14));
        mHeaderRadius = a.getDimensionPixelSize(R.styleable.DashboardView_headerRadius1, mRadius / 3);
        mPointerRadius = a.getDimensionPixelSize(R.styleable.DashboardView_pointerRadius1, mRadius / 3 * 2);
        mCircleRadius = a.getDimensionPixelSize(R.styleable.DashboardView_circleRadius1, mRadius / 17);
        mMinValue = a.getInteger(R.styleable.DashboardView_minValue1, 0);
        mMaxValue = a.getInteger(R.styleable.DashboardView_maxValue1, 100);
        mRealTimeValue = a.getFloat(R.styleable.DashboardView_realTimeValue1, 0.0f);
        mStripeWidth = a.getDimensionPixelSize(R.styleable.DashboardView_stripeWidth1, 0);
        mModeType = a.getInt(R.styleable.DashboardView_stripeMode1, 0);
        mBgColor = a.getColor(R.styleable.DashboardView_bgColor1, 0);
