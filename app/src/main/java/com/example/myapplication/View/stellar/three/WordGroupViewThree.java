...
public class WordGroupViewThree extends View {
    ...
    public WordGroupViewThree(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//            buildPoints(mPoints, getFullContent(0),i, 0);
        ...
        Log.e(TAG,"诶呀我去：" + drawPointList.size() + "==" +keyWords.size() + "==" + getFullContent(0).length);
        /**
         * 绘制真实的效果
         */
