...
public class SpreadView extends View {
    ...
    private Paint centerPaint = new Paint();; //中心圆paint
    ...
    public SpreadView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        Log.e("TAG","----------------33333333333333333333333333333:" + radius);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (spreadRadius.size() > 0 && spreadRadius.get(spreadRadius.size() - 1) > maxRadius) {
            spreadRadius.add(0);
            alphas.add(255);
        }
        ...
        Log.e("TAG","----------------22222222222222222:" + centerPaint);
        Log.e("TAG","----------------22222222222222222:" + centerX);
        Log.e("TAG","----------------22222222222222222:" + radius);
