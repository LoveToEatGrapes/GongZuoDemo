package com.example.myapplication.View.stellar.stellarMapFoure;
...
public class RandomLayoutFoure extends ViewGroup {
     ...
     * 构造方法
     */
    public RandomLayoutFoure(Context context) {
        super(context);
        init();
    }
    ...
    private void generateChildren() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            TextView newChild = (TextView) mAdapter.getView(i, convertView);
            newChild.setTextSize(UIUtils.dp2px(3+i));
