...
import  static com.example.myapplication.View.stellar.two.RandomLayoutTwo.LayoutData.SIZE_12SP;
import static com.example.myapplication.View.stellar.two.RandomLayoutTwo.LayoutData.SIZE_14SP;
import static com.example.myapplication.View.stellar.two.RandomLayoutTwo.LayoutData.SIZE_22SP;
import static com.example.myapplication.View.stellar.two.RandomLayoutTwo.LayoutData.SIZE_24SP;
import static com.example.myapplication.View.stellar.two.RandomLayoutTwo.LayoutData.SIZE_30SP;


public class RandomLayoutTwo extends ViewGroup {
    ...
    public RandomLayoutTwo(Context context) {
        this(context, null);
    }

    public RandomLayoutTwo(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RandomLayoutTwo(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        set.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                if (mAnimationEndListener != null) {
                    mAnimationEndListener.onAnimationEnd(RandomLayoutTwo.this,mAnimationCount);
                }
            }
    ...
    private TextView getTextView(LayoutData layoutData) {
        ...
        CircleViewTwo txv = new CircleViewTwo(mContext);
...
//        txv.setOnClickListener(itemClickListener);
    ...
    @IntDef({LayoutData.SIZE_10SP, SIZE_12SP, SIZE_14SP, LayoutData.SIZE_16SP, LayoutData.SIZE_18SP, LayoutData.SIZE_20SP, SIZE_22SP, SIZE_24SP, LayoutData.SIZE_26SP, LayoutData.SIZE_28SP, SIZE_30SP})
