 ...
 */
public class DashBoardTwo extends View {
    ...
    public DashBoardTwo(Context context) {
        super(context);
        init();
    }
    ...
    public DashBoardTwo(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public DashBoardTwo(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
